...
{
    class GoldRushGameContainer
    {
        //List<Game> gameList = new List<Game>();
        public Dictionary<int, GoldRushGame> games_Dictionary = new Dictionary<int, GoldRushGame>();

        public GoldRushGameContainer() { }

        public void AddGame(String level_num, int hp, String game_speed, int id, List<String> players)
        {
            GoldRushGame game = new GoldRushGame(level_num, hp, game_speed, id, players);
            //gameList.Add(game);
